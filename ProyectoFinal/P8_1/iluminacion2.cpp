...
glm::vec3 spotLightPositions_Direction[] = {
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].ambient"), lightColor2.x, lightColor2.y, lightColor3.z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].diffuse"), lightColor2.x, lightColor2.y, lightColor3.z);
		...
		// SpotLight
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.position"), spotLightPositions_Direction[0].x, spotLightPositions_Direction[0].y, spotLightPositions_Direction[0].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), spotLightPositions_Direction[1].x, spotLightPositions_Direction[1].y, spotLightPositions_Direction[1].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 1.0f, 1.0f, 1.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 1.0f, 1.0f, 1.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.specular"),1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.constant"), 1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.linear"), 1.0f);
...
void DoMovement()
{
	...
	if (keys[GLFW_KEY_1]) { spotLightPositions_Direction[0].x += 0.01f; }
	if (keys[GLFW_KEY_2]) { spotLightPositions_Direction[0].x -= 0.01f; }
	if (keys[GLFW_KEY_3]) { spotLightPositions_Direction[0].y += 0.01f; }
	if (keys[GLFW_KEY_4]) { spotLightPositions_Direction[0].y -= 0.01f; }
	if (keys[GLFW_KEY_5]) { spotLightPositions_Direction[0].z += 0.01f; }
	if (keys[GLFW_KEY_6]) { spotLightPositions_Direction[0].z -= 0.01f; }


	if (keys[GLFW_KEY_7]) { spotLightPositions_Direction[1].x += 0.01f; }
	if (keys[GLFW_KEY_8]) { spotLightPositions_Direction[1].x -= 0.01f; }
	if (keys[GLFW_KEY_9]) { spotLightPositions_Direction[1].y += 0.01f; }
	if (keys[GLFW_KEY_0]) { spotLightPositions_Direction[1].y -= 0.01f; }
	if (keys[GLFW_KEY_O]) { spotLightPositions_Direction[1].z += 0.01f; }
	if (keys[GLFW_KEY_P]) { spotLightPositions_Direction[1].z -= 0.01f; }
